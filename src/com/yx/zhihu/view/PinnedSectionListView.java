...
package com.yx.zhihu.view;

import com.yx.zhihu.BuildConfig;
...
public class PinnedSectionListView extends ListView {
	...
	private boolean isPinneVis  = true;
    ...
    void ensureShadowForPosition(int sectionPosition, int firstVisibleItem, int visibleItemCount) {
        ...
        if (mPinnedSection == null) { // create shadow, if empty
            ...
            sectionChangeListener.onSectionChange(sectionPosition);
        }
    ...
    public void setOnSectionChangeListener(SectionChangeListener listener){
    	sectionChangeListener = listener ;
    }
    public interface SectionChangeListener{
    	public void onSectionChange(int position);
    }
	public void setPinnedStatus(boolean flag) {
		isPinneVis   = flag;
	}
}
